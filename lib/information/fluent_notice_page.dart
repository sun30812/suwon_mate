...
class FluentNoticePage extends StatefulWidget {
  const FluentNoticePage({Key? key}) : super(key: key);

  @override
  State<FluentNoticePage> createState() => _FluentNoticePageState();
}

class _FluentNoticePageState extends State<FluentNoticePage> {
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            if (!snapshot.hasData) {
              return const Column(
                ...
                children: [ProgressRing(), Text('공지사항 불러오는 중..')],
              );
