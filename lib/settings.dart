...
class BottomBannerSettingWidget extends ConsumerWidget {
  const BottomBannerSettingWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    var bannerSetting = ref.watch(functionSettingControllerNotifierProvider.select((value) => value.bottomBanner));
    return InfoCard(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Switch(
                      ...
                      value:
                      bannerSetting,
                      onChanged: ref.read(functionSettingControllerNotifierProvider.notifier).onBottomBannerSettingChanged),
                ],
              ),
            ),
          ],
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const FunctionSettingWidget(),
          const BottomBannerSettingWidget(),
          InfoCard(
            icon: Icons.restore,
            title: '초기화 메뉴',
            detail: Column(
